...
<body>
    <h1>จำนวนทรัพย์สินที่เก็บได้ตามชั้น</h1>

    <!-- แสดงกราฟ -->
    <canvas id="my_found_Chart" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 653px;" width="653" height="250" class="chartjs-render-monitor"></canvas>
    ...
    var ctx = document.getElementById('my_found_Chart').getContext('2d');
    var my_found_Chart = new Chart(ctx, {
