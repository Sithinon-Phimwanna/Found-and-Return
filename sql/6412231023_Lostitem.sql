...
--
-- Host: localhost:3306
-- Generation Time: 18 ก.พ. 2025 เมื่อ 03:28 PM
...
INSERT INTO `found_items` (`found_id`, `finder_name`, `finder_contact`, `found_name`, `found_description`, `found_date`, `found_location`, `found_image`, `status_id`) VALUES
...
(15, 'นาย สตาฟ ทดสอบ', 'staff@psru.ac.th', 'กุญแจ', 'กุญแจ', '2025-01-30 02:34:00', '6', '2025-01-30_09-34-19_003.jpg', '03-02-2025_10-40-25_k1.jpg,03-02-2025_10-40-25_Prod_2.png', 'นายทดสอบ ระบบสารสนเทศ', 3),
...
--
ALTER TABLE `found_items`
  MODIFY `found_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;
